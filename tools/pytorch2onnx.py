...
from lib.models.detector.Unet_detector import Unet_Detector
try:
    import onnx
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert keypoint models to ONNX')
    parser.add_argument('--checkpoint_path', type=str, default='./weights/2023-09-14-06-42/checkpoint_best.pt')
    parser.add_argument('--show', action='store_true', help='show onnx graph')
    parser.add_argument('--output-file', type=str, default='./tools/tmp.onnx')
    ...
    parser.add_argument(
        ...
        type=int,
        nargs='+',
        default=[1, 3, 320, 512],  # [1, 3, 704, 1280]
        help='input size')
